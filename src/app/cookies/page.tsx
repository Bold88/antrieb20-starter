...
export const metadata = {
  ...
  description: "Informationen zu Cookies auf dieser Website.",
};
        ...
        <section className="relative w-full py-16">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl relative">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto">Hier erfahren Sie, wie und warum wir Cookies auf unserer Website einsetzen.</p>
            </div>
            <div className="glass-morphism p-8 rounded-2xl border-2 border-primary/10 mb-8">
              ...
              <p className="mb-4">Cookies sind kleine Textdateien, die von Ihrem Browser auf Ihrem Endgerät gespeichert werden. Sie dienen dazu, unsere Website nutzerfreundlicher, effektiver und sicherer zu machen.</p>
              <h2 className="text-2xl font-semibold mb-4 mt-8">Welche Cookies verwenden wir?</h2>
              <ul className="list-disc pl-6 space-y-2">
                <li><b>Essenziell:</b> Notwendige Cookies, die für den Betrieb der Website unerlässlich sind.</li>
